...
def SearchFriends():
	...
	return render_template('hello.html', message = name, photos=getUsersPhotos(uid), comments = getAllPhotosLikes(uid), base64=base64)
...
@flask_login.login_required
def protected():
	return render_template('hello.html', name=flask_login.current_user.id, photos=getUsersPhotos(getUserIdFromEmail(flask_login.current_user.id)), comments = getAllPhotosLikes(getUserIdFromEmail(flask_login.current_user.id)), base64=base64, message="Here's your profile")
